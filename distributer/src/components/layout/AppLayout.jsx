...
const links = [
  ...
  { to: '/orders', label: 'Orders', icon: 'list' },
  {
    ...
    children: [
      ...
      { to: '/team/binary', label: 'Matching Team' },
    ],
  },
  {
    label: 'Rewards',
...
const titles = {
  ...
  '/team/left': ['Left Team', 'Members on your left matching leg'],
  '/team/right': ['Right Team', 'Members on your right matching leg'],
  '/team/binary': ['Matching Team', 'View your matching tree'],
