...
const WELLNESS_PERMISSIONS = [
    ...
    { route: '/get-binary-legs', routeFor: 'distributor', method: 'GET', roles: ['distributor'], menuMeta: { label: 'Matching Legs', icon: 'users', order: 42, showInMenu: false }, description: 'Distributor left and right matching leg lists' },
    { route: '/get-binary-tree', routeFor: 'distributor', method: 'GET', roles: ['distributor'], menuMeta: { label: 'Matching Tree', icon: 'users', order: 43, showInMenu: false }, description: 'Distributor matching tree view' },
