...
const distributorWalletSchema = new mongoose.Schema({
    uid: { type: Number, required: true, unique: true },
    wallets: { type: [walletEntrySchema], default: [] }
}, {
    timestamps: true,
    collection: 'distributor_wallets'
});

module.exports = mongoose.model('DistributorWallet', distributorWalletSchema);
