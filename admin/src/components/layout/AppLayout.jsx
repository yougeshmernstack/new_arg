...
const links = [
  ...
  { to: '/theme-users', label: 'Theme Users', icon: 'users' },
  ...
  { to: '/inventory', label: 'Inventory', icon: 'layers' },
  {
    ...
    children: [
      ...
      { to: '/orders/guest', label: 'Guest Invoices', badgeKey: 'guest' },
      { to: '/orders/guest/create', label: 'Create Guest Invoice' },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/website/home-story', label: 'Homepage Story' },
      { to: '/website/social', label: 'Social Media' },
      { to: '/website/about', label: 'About & Founders' },
      { to: '/website/reviews', label: 'Reviews & Testimonials' },
